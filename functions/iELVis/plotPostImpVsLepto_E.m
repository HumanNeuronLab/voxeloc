function [figH, axH]=plotPostImpVsLepto_E(sub,printEm,plotPial)
...
%rgb=zeros(nElec,3);
rgb=vals2Colormap_E(shiftDist,'justpos');
figH(1)=figure;
...
for a=1:nChan,
    ...
    set(h,'color',rgb(a,:));
    clickText_E(h,[num2str(a) ': ' chanName{a}]);
    xlabel('Channel');
