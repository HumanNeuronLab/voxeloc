function [elecMatrix, elecLabels, elecRgb, elecPairs, elecPresent]=mgrid2matlab_E(mgridFname,import_ref)
...
if nargin<1
    ...
    if ~isequal(class(mgridFname),'struct')
        ...
        mgridFname = fullfile(mgridFname.glassbrain.UserData.voxelocDir,[mgridFname.glassbrain.UserData.patientID '.mgrid']);
    end
end
if nargin<2,
   import_ref=0; 
