...
%     widget.viewer.(currVol).ax_sliceView3.YLabel.String = 'Z →';
    ...
    widget.viewer.(currVol).button_selectNifti = uibutton('Parent',widget.viewer.(currVol).panel_sliceView4,'Text','Select NIfTI file','BackgroundColor',[1,0.65,0],'Enable','off');
    ...
    widget.viewer.(currVol).button_resetView = uibutton('Parent', widget.viewer.(currVol).panel_sliceView4,'Text','Reset View','Enable','off','BackgroundColor',[0.5,0.5,0.5],'FontColor',[1 1 1]);
