        ...
        switch wS
            case 'init'
                ...
                pV.gridInner = uigridlayout('Parent',pV.panel,...
                    'ColumnWidth',{150,200,22,100,'1x'},'RowHeight',{100,22,22,22,22,22,22,22,22,22,'1x',35},...
...
%                 pV.lamp_electrodes = uilamp('Parent',pV.gridInner,'Color',[1 0 0]);
                ...
                pV.label_forceSave.Layout.Row = 10;
            ...
            case 2
                ...
                elseif isequal(evt.EventName,'ButtonPushed')
                    ...
                    if cDir ~= 0
                        ...
                        pV.field_patientDir.FontColor = [0 0 0];
                ...
                switch src.Tag
                    case 'CT'
                        if (file ~= 0)
                            ...
                            pV.field_ctFile.FontColor = [0 0 0];
                    ...
                    case 'T1'
                        if (file ~= 0)
                            ...
                            pV.field_t1File.FontColor = [0 0 0];
                    ...
                    case 'PARC'
                        if (file ~= 0)
                            ...
                            pV.field_parcFile.FontColor = [0 0 0];
